...
/* ====== ПРОСТОЙ КАЛЕНДАРЬ + СЛОТЫ + ПРАВАЯ КОЛОНКА ======
   Идея простая:
   - Рисуем сетку дней: пустые кнопки до первого дня, затем 1..N.
   - Клик по дню → слоты.
   - Клик по слоту → включаем «Дальше», переносим дату/время вправо и в форму.
   - «Дальше» открывает форму.
   - Аккордеон сворачивается/разворачивается.
==========================================================*/
